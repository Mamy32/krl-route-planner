            ...
            <div className="grid grid-cols-2 gap-2">
              ...
              {routeResult.optimization === "shortest" ? (
                <Stat
                  ...
                  label="Distance"
                  value={`${routeResult.totalDistance?.toFixed(2)} km`}
                />
              ) : routeResult.optimization === "transfers" ? (
                <Stat
                  icon={<ArrowDownUp className="w-4 h-4" />}
                  label="Minimum Transfers"
                  value={`${routeResult.transfers}`}
                />
              ) : (
                <Stat
                  icon={<Clock className="w-4 h-4" />}
                  label="Travel Time"
                  value={`${routeResult.totalTime} min`}
                />
              )}
              ...
              <Stat
                ...
                label="Stations"
                value={String(
                  routeResult.stationNames.length
                )}
              />
...
<Stat
  ...
  value={
    routeResult.fare
      ? `Rp ${routeResult.fare.toLocaleString(
          "id-ID"
        )}`
      : "-"
  }
/>
              ...
              <Stat
                ...
                label="Runtime"
                value={`${routeResult.runtime.toFixed(
                  4
                )} ms`}
              />
            </div>
