    ...
    <Card className="shadow-md border-border/60">
      ...
      <CardContent className="space-y-5">
        ...
        <div className="space-y-2">
          ...
          <RadioGroup value={p.algorithm} onValueChange={p.onAlgorithmChange} className="space-y-2">
            <div className="flex items-center gap-2 rounded-md border border-border/60 px-3 py-2 hover:bg-accent/50 transition-colors">
              <RadioGroupItem value="dijkstra" id="dijkstra" />
              <Label htmlFor="dijkstra" className="cursor-pointer flex-1 text-sm">Dijkstra Algorithm</Label>
            </div>
            <div className="flex items-center gap-2 rounded-md border border-border/60 px-3 py-2 hover:bg-accent/50 transition-colors">
              <RadioGroupItem value="bellman" id="bellman" />
              <Label htmlFor="bellman" className="cursor-pointer flex-1 text-sm">Bellman-Ford Algorithm</Label>
            </div>
          </RadioGroup>
        </div>
